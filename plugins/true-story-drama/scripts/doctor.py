...
REQUIRED_FILES = (
    ...
    "skills/true-story-drama/assets/fact-confirmation-template.md",
...
def inspect_package() -> dict[str, Any]:
    ...
    return {
        ...
        "notes": [
            ...
            "先确认故事大意和主题，再确认事实底稿，之后才能进入短剧化。",
            "剧本默认以人物行动和自然对话推进，旁白只在必要处出现。",
            "剧本交付前必须完成旁白删除测试、台词去AI化和朗读检查。",
            "视频提示词必须按连续秒数分段，写清景别、机位、运镜、可见情绪和结束状态。",
